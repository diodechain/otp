...
#endif // wxUSE_WEBVIEW
#if wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,1)
extern void wxWebView_RunScript(WxeApp *app, wxeMemEnv *memenv, wxeCommand& Ecmd);
#endif // wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,1)
#if wxUSE_WEBVIEW
...
#endif // wxUSE_WEBVIEW
#if wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,4)
extern void wxWebView_GetZoomFactor(WxeApp *app, wxeMemEnv *memenv, wxeCommand& Ecmd);
#endif // wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,4)
#if wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,4)
...
#endif // wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,4)
#if wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
extern void wxWebViewIE_MSWSetEmulationLevel(WxeApp *app, wxeMemEnv *memenv, wxeCommand& Ecmd);
#endif // wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
#if wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
extern void wxWebViewIE_MSWSetModernEmulationLevel(WxeApp *app, wxeMemEnv *memenv, wxeCommand& Ecmd);
#endif // wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
#if wxUSE_WEBVIEW
...
#endif // wxUSE_WEBVIEW && wxCHECK_VERSION(3,1,4)
#if wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
  {wxWebViewIE_MSWSetEmulationLevel, "wxWebViewIE", "mSWSetEmulationLevel", 1}, // 3603
#else
  {NULL, "wxWebViewIE", "mSWSetEmulationLevel", 0}, // 3603
#endif // wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
#if wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
  {wxWebViewIE_MSWSetModernEmulationLevel, "wxWebViewIE", "mSWSetModernEmulationLevel", 1}, // 3604
#else
  {NULL, "wxWebViewIE", "mSWSetModernEmulationLevel", 0}, // 3604
#endif // wxUSE_WEBVIEW_IE && wxUSE_WEBVIEW_IE && wxCHECK_VERSION(3,1,3)
#if wxUSE_WEBVIEW
