...
#if wxUSE_WEBVIEW
     {wxEVT_WEBVIEW_NAVIGATING, 247, "webview_navigating", "wxWebViewEvent", "wxWebView"},
#endif
#if wxUSE_WEBVIEW
     {wxEVT_WEBVIEW_NAVIGATED, 247, "webview_navigated", "wxWebViewEvent", "wxWebView"},
#endif
#if wxUSE_WEBVIEW
     {wxEVT_WEBVIEW_LOADED, 247, "webview_loaded", "wxWebViewEvent", "wxWebView"},
#endif
#if wxUSE_WEBVIEW
     {wxEVT_WEBVIEW_ERROR, 247, "webview_error", "wxWebViewEvent", "wxWebView"},
#endif
#if wxUSE_WEBVIEW
     {wxEVT_WEBVIEW_NEWWINDOW, 247, "webview_newwindow", "wxWebViewEvent", "wxWebView"},
#endif
#if wxUSE_WEBVIEW
     {wxEVT_WEBVIEW_TITLE_CHANGED, 247, "webview_title_changed", "wxWebViewEvent", "wxWebView"},
#endif
     {-1, 0, "", "", ""}
  };
